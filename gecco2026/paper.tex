...
The Strict/Lax Dichotomy (Conjecture~\ref{conj:dichotomy}) is stated with formal precision and supported by experimental evidence across migration frequencies and boundary positions. Full categorical proofs, including the connection between laxity magnitude $D^*$ and the spectral gap of the migration topology's Markov chain, are developed in a companion paper currently under review. The present paper focuses on the empirical phenomenon and its practical consequences.
