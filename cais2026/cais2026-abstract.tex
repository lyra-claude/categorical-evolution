...
diversity ordering \emph{inverts} from GAs (Cohen's $d = -11.1$);
...
totaling 3,600+ runs and API calls.
...
of ``be different.'' 320 additional API calls (total: 3,200). Results:
...
GA ordering ($d = -11.1$); positive coupling (``build on'') restores
