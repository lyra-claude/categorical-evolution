...
HERA~\cite{hera2026} is closest: it tracks cycle count during
topology evolution (38.69\% improvement), but does not control density.
...
$K$-regular graphs maximize coordination ($\beta_{\min} \sim 1/K$),
suggesting a coordination--exploration duality where the optimal
topology balances competing demands.
Artis et al.~\cite{artis2026heterogeneity} propose the Principle of
Maximum Heterogeneity: performance-maximising distributed systems
converge on heterogeneous configurations, with topology determining
heterogeneity's spatial distribution. This cross-disciplinary evidence
(biology, economics, computing) supports our finding that ring
topologies outperform fully connected graphs on rugged landscapes.
