...
density, diameter, and spectral gap.
...
matter? An 8-node ring and star both have $\beta_1 = 1$ and $|E| = 8$,
but different degree distributions (2-regular vs.\ hub-and-spoke).

\paragraph{Design.}
Two topologies on $n = 8$ nodes: ring (2-regular, diameter~4,
$\lambda_2 \approx 0.586$) and star (irregular, diameter~2,
...
expression evaluator, Bloom filter), four topologies (none (agents receive no neighbours' outputs), ring,
