...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{iso-dense-graphs.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.85\linewidth]{eta-squared-vs-k.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.85\linewidth]{ring-vs-star-diversity.pdf}
...
different timescales (Table~\ref{tab:bridge}, Figures~\ref{fig:bridge-diversity}--\ref{fig:bridge-eta2}):
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{bridge-diversity-generations.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{bridge-eta2-temporal.pdf}
\caption{Temporal evolution of $\eta^2$ in the bridge experiment. $\beta_1$
produces a transient effect peaking at generation~100 and fading by
generation~500. $\lambda_2$ produces a persistent effect emerging at
generation~200 and not fading. Two invariants operate at distinct timescales.}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{llm-diversity-heatmap.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.85\linewidth]{invariant-hierarchy.pdf}
...
\noindent
Whether these form a nested hierarchy (Figure~\ref{fig:hierarchy}; $\kappa$ modulates $\beta_1$
