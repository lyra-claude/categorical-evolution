...
$p < 3.7 \times 10^{-11}$). We conjecture that strict composition preserves
...
\item We introduce \emph{diversity fingerprints}---compositional invariants that
  ...
  topology optimization), with effect size $d = 4.34$ and $p < 3.7 \times
  10^{-11}$.
...
domains ($d = 4.34$, $p < 3.7 \times 10^{-11}$), and we conjecture
...
models where different subpopulations run different strategies.
The migration natural transformation may admit a braided monoidal
structure, connecting island topology to diversity dynamics via the
coherence conditions of the braiding---a direction we leave for
future work.
The optimization zoo is converging. Category theory provides the
